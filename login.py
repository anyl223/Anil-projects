...
class Login:
   ...
   def loginform(self):
      ...
      img=Label(self.root,image=self.img).place(x=0,y=0,width=1366,height=700)
   ...
   def login(self):
      ...
      if self.email_txt.get()=="" or self.password.get()=="":
         ...
         try:
            ...
            con=pymysql.connect(host='localhost',user='root',password='Ansu1992@12',database='pythongui')

            cur=con.cursor()

            cur.execute('select * from register where  ' + str(r'"Email id"') + str('=%s') + str('and password=%s')
   ...
   def register(self):
      ...
      if self.entry.get()==""or self.entry2.get()==""or self.entry3.get()==""or self.entry4.get()=="":
         ...
         try:
            ...
            con=pymysql.connect(host="localhost",user="root",password="Ansu1992@12",

                              database="pythongui")

            cur=con.cursor()

            cur.execute("select * from register where " + str(r'"email-id"') + str('=%s')
   ...
   def appscreen(self):
      ...
      label1=Label(Frame_login,text="Hi! Welcome please give feedback"
      ...
      label2=Label(Frame_login,text="finally you got ,what you want"
      ...
      label3=Label(Frame_login,text="welcome to this portal"
